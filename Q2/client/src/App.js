 ...
 * has all the bike bookings previously added and CRUD actions. The  
 * table is populated by the '/api/get/post' API in index.js file in the server folder.
 * The AddEdit page adds('api/get/post') or updates('api/get/update') bike bookings 
 * and the View('api/get') page displays a summary of the data.
 */
